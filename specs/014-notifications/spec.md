...
2. El Usuario B reclama la laptop. Verificar que el Usuario A recibe una notificación: *"Nueva solicitud de reclamación recibida para tu reporte 'Laptop encontrada'"*.
3. El Usuario A acepta el reclamo. Verificar que el Usuario B recibe una notificación: *"Tu solicitud de reclamación para 'Laptop encontrada' ha sido aceptada"*.
4. El Usuario A envía un mensaje de chat al Usuario B. Si el Usuario B está en la página de feed, verificar que recibe una notificación: *"Nuevo mensaje de David Perez: [contenido]"*. Si el Usuario B está dentro de la misma pantalla de chat de esa conversación, verificar que no se le genera notificación.
