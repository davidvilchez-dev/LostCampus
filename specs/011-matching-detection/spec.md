...
2. **Given** que un reporte no tiene coincidencias sugeridas, **When** se carga el detalle, **Then** muestra el mensaje descriptivo *"No se encontraron coincidencias en este momento"*.
...
- **FR-004**: Las tarjetas de coincidencia deben mostrar visualmente el porcentaje calculado (ej: *"75% de coincidencia"*).
