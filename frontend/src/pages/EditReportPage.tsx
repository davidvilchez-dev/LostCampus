...
export default function EditReportPage() {
  ...
  return (
    <div className="flex flex-col space-y-4">
      {/* Encabezado con botón de retorno al lado */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-brand-text tracking-tight">Editar reporte</h1>
        ...
        <button
          onClick={() => navigate(-1)}
          className="flex items-center space-x-2 text-xs font-semibold text-brand-muted hover:text-brand-text transition-colors duration-200 bg-brand-border-dark/30 hover:bg-brand-border-dark/60 py-2 px-3 rounded-lg border border-brand-border-dark/60 self-start md:self-center"
        >
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
        ...
        <div className="rounded-2xl border border-brand-border-dark bg-brand-card p-4 lg:p-5 space-y-4 shadow-xl">
          <div>
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 py-2.5 px-4 rounded-xl text-sm font-semibold border transition-all duration-200 cursor-pointer ${
                  tipo === 'PERDIDO'
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative">
              <select
                ...
                className={`w-full bg-[#131c31] border rounded-xl py-2 pl-3 pr-10 text-sm text-brand-text outline-none transition-all appearance-none cursor-pointer ${
                  errors.categoria
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <textarea
              ...
              className="w-full bg-[#131c31] border border-brand-border-dark hover:border-[#24355a] focus:border-brand-accent focus:shadow-[0_0_12px_rgba(59,130,246,0.15)] rounded-xl py-2 px-3 text-sm text-brand-text placeholder-brand-muted/40 outline-none transition-all resize-none"
            />
          </div>
        </div>
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full bg-[#131c31] border rounded-xl py-2 pl-3 pr-10 text-sm text-brand-text outline-none transition-all ${
          ...
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full bg-[#131c31] border rounded-xl py-2 pl-10 pr-3.5 text-sm text-brand-text placeholder-brand-muted/40 outline-none transition-all ${
                  errors.lugar
                    ? 'border-red-500/60 focus:border-red-500 focus:shadow-[0_0_12px_rgba(239,68,68,0.15)]'
                    : 'border-brand-border-dark hover:border-[#24355a] focus:border-brand-accent focus:shadow-[0_0_12px_rgba(59,130,246,0.15)]'
                }`}
            ...
            <div
              ...
              className="w-full h-20 rounded-xl border border-brand-border-dark bg-brand-bg-dark hover:border-brand-accent/60 transition-all duration-300 relative overflow-hidden flex flex-col items-center justify-center cursor-pointer select-none group mt-1"
            >
              ...
              <MapPin className="w-5 h-5 text-brand-muted/50 group-hover:text-brand-accent group-hover:scale-110 transition-all duration-300 z-10" />
              <span className="text-xs font-bold text-brand-muted/70 group-hover:text-brand-text transition-colors mt-1.5 z-10">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col space-y-2 pt-1">
            ...
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="text-xs font-bold text-brand-muted hover:text-brand-text py-1 transition-colors cursor-pointer self-center hover:underline"
            >
              Cancelar
            </button>
          </div>
